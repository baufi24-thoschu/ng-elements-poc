...
const renameIndexHtml = () => {
  return src('./dist/apps/baufi24-disclaimer/index.html')
    .pipe(rename('index.bkup.html'))
    .pipe(dest("./dist/apps/baufi24-disclaimer"));
};
...
exports.default = series(build, concatJs, renameIndexHtml, copy);
exports.watch = run;
